    ...
    <Menu shadow="md" width={200} position="bottom-end" withArrow>
      ...
      <Menu.Dropdown>
        ...
        <Menu.Item
          ...
          onClick={() => handleUpdate('delivered', 'Package safely received at Hub')}
        >
          Confirm Hub Arrival
        </Menu.Item>
        ...
        <Menu.Item
          leftSection={<AlertTriangle size={14} />}
          color="red"
          onClick={() => handleUpdate('failed_attempt', 'Shipment rejected or address unreachable')}
        >
          Mark as Failed
        </Menu.Item>
        ...
        <Menu.Item
          ...
          color="pink"
          onClick={() => handleUpdate('returned', 'Initiating return to vendor')}
        >
          Mark as Returned
        </Menu.Item>
      </Menu.Dropdown>
