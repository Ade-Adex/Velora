...
export default function AdminSidebar({
  ...
  return (
    ...
    >
      {/* Sidebar Header */}
      <div
        className={`hidden md:block transition-all duration-300 overflow-hidden whitespace-nowrap ${isExpanded ? 'p-8' : 'p-4 py-8'}`}
      >
        {isExpanded ? (
          <>
          ...
          <Title order={3} fw={900} className="text-center">
      ...
      {/* Footer Actions */}
      <div
        className={`border-t border-white/10 bg-white/5 transition-all duration-300 ${isExpanded ? 'p-6' : 'p-4'}`}
      >
        <Link
          href="/"
