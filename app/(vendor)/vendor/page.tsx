      ...
      <Group justify="space-between" align="flex-end">
        <div>
          ...
          <Text c="dimmed" size="sm" fw={500}>
            Welcome back, {user.vendorProfile?.shopName || user.fullName}.
          </Text>
        </div>
      ...
      <Grid gap="md">
        <Grid.Col span={{ base: 12, lg: 8 }}>
          <Paper withBorder radius="lg" shadow="sm">
            ...
            >
              <Text fw={800} size="xs" tt="uppercase" c="dimmed" lts="1px">
                  ...
                  {allOrders.map((order) => {
                    ...
                    return (
                      <tr
                        ...
                        className="border-t border-gray-100 hover:bg-indigo-50/20 transition-colors"
                      >
                        <td className="p-4">
                          <Text size="sm" fw={800}>
                            #{order.orderNumber}
                        ...
                        <td className="p-4">
                          <Text size="sm" fw={900} c="indigo.7">
          ...
          <Stack gap="md">
            ...
            >
              ...
              <Text size="sm" opacity={0.8} mb="xl" fw={500}>
                Your shop is performing better than 70% of local merchants.
                Focus on &quot;Electronics&quot; to boost Q3 revenue.
              </Text>
              <Button
                variant="white"
                color="indigo.9"
